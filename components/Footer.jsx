    ...
    const linkSections = [
        {
            title: "CATEGORIES",
            links: [
                { text: "Electronics", path: '/shop', icon: null },
                { text: "Fashion", path: '/shop', icon: null },
                { text: "Collectibles", path: '/shop', icon: null },
                { text: "Home & Garden", path: '/shop', icon: null },
            ]
        },
        {
            title: "SELL ON BBAY",
            links: [
                { text: "How to Sell", path: '/', icon: null },
                { text: "Seller Dashboard", path: '/sell', icon: null },
                { text: "Create Listing", path: '/sell/create-listing', icon: null },
                { text: "Seller Policies", path: '/', icon: null },
            ]
        },
        {
            title: "CONTACT",
            links: [
                { text: "+977-061-123456", path: '/', icon: PhoneIcon },
                { text: "support@bbay.com.np", path: '/', icon: MailIcon },
                { text: "Lakeside, Pokhara-6, Kaski", path: '/', icon: MapPinIcon }
            ]
        }
    ];
        ...
        <footer className="mx-6 bg-white">
            <div className="max-w-7xl mx-auto">
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © bbay Nepal. All Rights Reserved.
                </p>
            </div>
        </footer>
    );
